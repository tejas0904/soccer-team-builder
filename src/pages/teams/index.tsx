...
{
  /* <FlexBetween>
          <Typography m="0 0 10px 0" variant="h4">Team A</Typography>
        </FlexBetween>
        <DataGrid disableRowSelectionOnClick disableColumnMenu rows={mockPlayers} columns={columns} hideFooter/>
        <FlexBetween>
          <Typography m="10px 0 10px 0" variant="h4">Team B</Typography>
        </FlexBetween>
        <DataGrid disableRowSelectionOnClick disableColumnMenu rows={mockPlayers} columns={columns} hideFooter/>
        <FlexBetween>
          <Typography m="10px 0 10px 0" variant="h4">Team C</Typography>
        </FlexBetween>
        <DataGrid disableRowSelectionOnClick disableColumnMenu rows={mockPlayers} columns={columns} hideFooter/> */
}
